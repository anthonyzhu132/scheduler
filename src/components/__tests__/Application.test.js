...
import { render,cleanup,waitForElement,fireEvent,getByText,getAllByTestId,getByAltText,getByPlaceholderText,queryByAltText,queryByText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  xit("loads data, books an interview and reduces the spots remaining for the first day by 1", async () => {
    ...
    await waitForElement(() => getByText(container, "Liam Martinez"));
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    await waitForElement(() =>
      getByText(appointment, "Liam Martinez")
    );
